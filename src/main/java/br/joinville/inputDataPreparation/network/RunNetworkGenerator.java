 ...
 */
public class RunNetworkGenerator{
	...
	public static void main(String[] args) {
		 ...
		 * The input file name.
		 */
		String osm = "./original-input-data/network/2018-11-22-from-geofabrik/allroads.osm.gz";
		...
		CoordinateTransformation ct = 
			 TransformationFactory.getCoordinateTransformation(TransformationFactory.WGS84, "EPSG:32722");
